        ...
        <div className='bg-black'>
            <div className='w-[95%]  m-auto flex flex-col sm:flex-row justify-center items-center  py-16 gap-20 md:gap-16 md:w-[90%] '>
                <div className='sm:w-1/2 flex justify-center items-center'>
                    <Image src="/pi.png" alt='Pic' width={1024} height={1024} className='rounded-full w-72 md:w-96 shadow-[0_0_5px_0px_rgba(0,0,0,0.3)] shadow-blue-500    '></Image>
                </div>
                <span className='sm:w-1/2 sm:mt-2'>
                    ...
                    <h1 className={` _text-Shadow ${nameFont.className} text-[3rem] lg:text-[4rem]`}>Zain Shah</h1>
                    <h2 className={`${font.className} font-extrabold text-lg md:text-xl`}>And I&apos;m a <span className='_text-Shadow text-blue-300 font-semibold'>Full Stack Developer</span></h2>
